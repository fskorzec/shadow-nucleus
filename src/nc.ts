...
export async function start(){
  ...
  if (fs.existsSync(`${nucleusExecFolderPath}/dist/modules/nc-cli/1.0.0/back/nc-cli.js`)) {
    //Load the nucleus cli plugin
    await _nucleus_api.Module.loadModule(`${nucleusExecFolderPath}/dist/modules/nc-cli/1.0.0/back/nc-cli.js`);
  }
