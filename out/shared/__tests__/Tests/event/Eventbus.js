...
describe("EventBus", () => {
    it("Should instanciate", () => {
        const evb = new EventBus_1.EventBus();
    ...
    it("Should set the depth to 1 if < 1", () => {
        const evb = new EventBus_1.EventBus("", 0);
...
Should be in '1' part`);
    ...
    it("should allow to unsubscribe", () => {
        const evb = new EventBus_1.EventBus(".", 2);
...
Should be in '1' part`);
    ...
    it("Should work with parent too", () => {
        const evbParent = new EventBus_1.EventBus(".", 2);
        const evbChild = new EventBus_1.EventBus(".", 2);
    ...
    it("Should throw an exception if eventName is not defined", () => {
        const bus = new EventBus_1.EventBus(".", 3);
        expect(() => {
            bus.on(void 0, () => { });
        }).toThrow(`The event name is not in the correct format :
Should be in '3' parts
